...
ChromeDriver driver = new ChromeDriver();
		...
		// Search for a table
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div[2]/div[1]/div/main/div/div[2]/div[1]/div[2]/input"))).sendKeys("actions");
