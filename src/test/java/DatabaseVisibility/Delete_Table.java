...
ChromeDriver driver = new ChromeDriver();
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div[2]/div[1]/div/main/div/div[2]/div[2]/table/tbody/tr[1]/td[6]/div/button[2]"))).click();
