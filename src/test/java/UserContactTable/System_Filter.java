...
ChromeDriver driver = new ChromeDriver();
		...
		// Click on the system filter and apply the filter
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div[2]/div[1]/div/main/div/div/div[2]/table/thead/tr[2]/td[1]/input"))).sendKeys("SimpleCRS");
