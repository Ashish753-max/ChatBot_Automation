...
public class External_DataBase {
...
ChromeDriver driver = new ChromeDriver();
		...
		// Click on the External Database
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div[1]/nav/div[4]/div/button[3]"))).click();
