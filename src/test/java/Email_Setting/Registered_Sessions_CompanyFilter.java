...
public class Registered_Sessions_CompanyFilter {
...
ChromeDriver driver = new ChromeDriver();
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div[2]/div[1]/div/main/div/div[4]/div[2]/table/thead/tr[2]/td[3]/input"))).sendKeys("3");
