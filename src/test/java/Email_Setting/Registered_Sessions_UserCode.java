...
public class Registered_Sessions_UserCode {
...
ChromeDriver driver = new ChromeDriver();
		...
		// enter the user code
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div[2]/div[1]/div/main/div/div[4]/div[2]/table/thead/tr[2]/td[2]/input"))).sendKeys("4");
