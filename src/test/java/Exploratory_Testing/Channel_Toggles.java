...
ChromeDriver driver = new ChromeDriver();
		...
		// Click on the Channel Toggles
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div[1]/nav/div[3]/div/button[3]"))).click();
