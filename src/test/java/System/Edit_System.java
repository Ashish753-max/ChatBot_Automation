...
ChromeDriver driver = new ChromeDriver();
		...
		// Click on the Edit button of the first system
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div[2]/div[1]/div/main/div/div[3]/div[2]/div/div[2]/table/tbody/tr[1]/td[5]/div/button[2]"))).click();
