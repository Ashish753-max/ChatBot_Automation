...
public class copy_tenant_Token {
...
ChromeDriver driver = new ChromeDriver();
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div[2]/div[1]/div/main/div/div[4]/table/tbody/tr[1]/td[6]/div/button[1]"))).click();
		
		// click on the copy button
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div[2]/div[1]/div/main/div/div[4]/table/tbody/tr[2]/td/div/div[2]/button"))).click();
